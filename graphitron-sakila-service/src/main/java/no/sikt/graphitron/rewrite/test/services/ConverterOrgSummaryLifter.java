...
/**
 * Fixture: lifter for {@code ConverterOrgSummary.org} ({@code @sourceRow} leaf-PK arm over
 ...
 * {@code parentKeyCellValue} helper extracts through when rebinding the cell at the
