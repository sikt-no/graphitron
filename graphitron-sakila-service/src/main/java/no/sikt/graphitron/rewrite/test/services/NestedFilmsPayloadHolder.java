...
/**
 * Compilation-tier fixture (producer #1): the nested-carrier counterpart of
 ...
 * {@code env.getSource()} to the parent backing class. Before this pass the nested carrier cast as
