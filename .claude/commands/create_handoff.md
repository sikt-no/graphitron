...
- create your file under `thoughts/shared/handoffs/GG-XXXX/YYYY-MM-DD_HH-MM-SS_ENG-ZZZZ_description.md`, where:
...
# Handoff: GG-XXXX {very concise description}
...
```bash
/resume_handoff thoughts/shared/handoffs/GG-2166/2025-01-08_13-44-55_GG-2166_create-context-compaction.md
```
</example_response>
