...
Graphitron is designed to be used with row-level security (RLS) in the database. The generated code executes queries directly against your tables—it does not add authorization logic at the application layer.
...
If you're not using RLS, you're on your own. we have not planned for this. You might be able to make it work, but you're probably better off with a different framework.
