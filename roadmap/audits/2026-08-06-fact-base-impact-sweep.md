...
| R569 mcp-aggregated-diagnostics | Consumer | Forward note only: pivot dimensions become violation-relation columns; aggregation becomes GROUP BY post-migration. |
