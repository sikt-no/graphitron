...
The classified carrier is `SourceKey.Reader.SourceRowsCall(LifterRef)` (`model/SourceKey.java:288`), produced from `@sourceRow`'s lifter resolution in `SourceRowDirectiveResolver`.
