...
* `CLAUDE.md`, "Writing style": replace the "top-down writing approach" sentence with a one-clause pointer: state the goal first, then the plan; `roadmap/workflow.adoc` § Item file conventions owns the shape. No second definition.
