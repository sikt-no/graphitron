...
Narrow to the pre-registry half: R589's capture reads the type-definition registry and turns assembly-stage failures (dangling references, malformed arguments) into located detections, which removes most of the throw-vs-report contract change this item scoped. A genuine syntax error, where parse cannot produce a registry at all, remains this item's case.
