...
- **Sibling slice of** [`typed-context-value-registry.md`](typed-context-value-registry.md) (R45) and [`multi-tenant-fanout.md`](multi-tenant-fanout.md) (R46). All three carved out of the original R31 spec.
