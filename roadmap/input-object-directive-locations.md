...
ignored-and-warned, and the model store codifies that reading: `graphitron_table_entry.type_name` is
...
if the store has shipped, as a comment or detection beside `graphitron_record_entry`, and the old
