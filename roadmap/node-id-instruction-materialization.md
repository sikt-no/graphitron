...
3. **The matrix was re-priced, and it moved the opposite way from the prediction.** `CELLS` went
   107 to 102, down rather than up. The reachability walk records a registration when it meets that
