...
This isn’t a new idea—compilers have long generated code from declarative specifications. ORMs map objects to tables. Query builders map method calls to SQL. Graphitron applies the same principle to the specific problem of implementing a GraphQL API over relational databases.
