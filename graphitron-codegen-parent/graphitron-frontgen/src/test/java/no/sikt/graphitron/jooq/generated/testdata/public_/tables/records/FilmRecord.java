...
public class FilmRecord extends UpdatableRecordImpl<FilmRecord> {
    ...
    /**
     * Setter for <code>public.film.sequel</code>.
     */
    public void setSequel(Long value) {
        set(14, value);
    }

    /**
     * Getter for <code>public.film.sequel</code>.
     */
     ...
     */
    public FilmRecord(Long filmId, String title, String description, Integer releaseYear, Long languageId, Long originalLanguageId, Short rentalDuration, BigDecimal rentalRate, Short length, BigDecimal replacementCost, MpaaRating rating, LocalDateTime lastUpdate, String[] specialFeatures, Object fulltext, Long sequel) {
        super(Film.FILM);
