...
public class FormatCodeBlocks {
    ...
    public static CodeBlock createNodeIdBlock(NodeConfiguration nodeConfiguration, String targetAlias) {
        return CodeBlock.of("$N.createId($S, $L)",
                ...
                commaSeparatedNodeIdFieldsBlock(nodeConfiguration, targetAlias)
        );
    }
    ...
    public static CodeBlock hasNodeIdOrIdsBlock(CodeBlock idOrRecordParamName, NodeConfiguration nodeConfiguration, String targetAlias, CodeBlock nodeIdFieldsBlock, boolean isMultiple) {
        return CodeBlock.of("$N.$L($S, $L, $L)",
                VAR_NODE_STRATEGY,
                isMultiple ? "hasIds" : "hasId",
                nodeConfiguration.typeId(),
                idOrRecordParamName,
                nodeIdFieldsBlock.isEmpty() ? commaSeparatedNodeIdFieldsBlock(nodeConfiguration, targetAlias) : nodeIdFieldsBlock
        );
    }
     ...
     */
    public static CodeBlock commaSeparatedNodeIdFieldsBlock(NodeConfiguration nodeConfiguration, String tableAlias) {
        return commaSeparatedTableFieldsBlock(CodeBlock.of("$N", tableAlias), nodeConfiguration.keyColumnsJavaNames());
    }
     ...
     */
    public static CodeBlock commaSeparatedNodeIdFieldsWithStaticTableInstanceBlock(NodeConfiguration nodeConfiguration) {
        return commaSeparatedTableFieldsWithStaticTableInstanceBlock(nodeConfiguration.javaTableName(), nodeConfiguration.keyColumnsJavaNames());
    }
     ...
     */
    public static CodeBlock commaSeparatedTableFieldsWithStaticTableInstanceBlock(String tableJavaName, List<String> fieldJavaNames) {
        return commaSeparatedTableFieldsBlock(staticTableInstanceBlock(tableJavaName), fieldJavaNames);
    }
     ...
     */
    public static CodeBlock commaSeparatedTableFieldsBlock(CodeBlock tableRef, List<String> fieldJavaNames) {
