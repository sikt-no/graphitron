...
public class DatabaseOperationInputParser {
    ...
    /**
     * Creates a new parser for the given schema and target field.
     *
     * @param processedSchema the schema containing type definitions
     * @param target the field whose arguments will be parsed
     */
    public DatabaseOperationInputParser(ProcessedSchema processedSchema, ObjectField target) {
        this.processedSchema = processedSchema;
        this.referenceField = target;
    }

    /**
     * Parses the reference field's arguments into categorized input components.
     *
