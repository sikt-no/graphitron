 ...
 * {@link no.sikt.graphitron.rewrite.type.GraphitronType.TableType}. {@code table} carries the
 * outcome of resolving the type's {@code @table} directive: a
 * {@link no.sikt.graphitron.rewrite.type.TableRef.ResolvedTable} when the table was found in the
 * jOOQ catalog, or an {@link no.sikt.graphitron.rewrite.type.TableRef.UnresolvedTable} when it was
 ...
 * {@link no.sikt.graphitron.rewrite.type.GraphitronType.TableType} (e.g. a result type,
 * interface, or union).
 *
 */
public sealed interface ReturnTypeRef permits ReturnTypeRef.TableBoundReturnType, ReturnTypeRef.OtherReturnType {
     ...
     * {@link no.sikt.graphitron.rewrite.type.GraphitronType.TableType}.
