 ...
 */
public class JdbcBatchUpdateDBMethodGenerator extends DBMethodGenerator<ObjectField> {
    ...
    public JdbcBatchUpdateDBMethodGenerator(ObjectDefinition localObject, ProcessedSchema processedSchema) {
