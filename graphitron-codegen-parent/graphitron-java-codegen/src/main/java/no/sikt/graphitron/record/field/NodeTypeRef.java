...
public sealed interface NodeTypeRef
     ...
     * {@link no.sikt.graphitron.record.type.GraphitronType.TableType} or does not carry
     * {@code @node}.
     *
     ...
     *
     * <p>The type name is stored on the parent {@link ChildField.NodeIdReferenceField}.
     * The {@link no.sikt.graphitron.record.GraphitronSchemaValidator} reports an error distinct
