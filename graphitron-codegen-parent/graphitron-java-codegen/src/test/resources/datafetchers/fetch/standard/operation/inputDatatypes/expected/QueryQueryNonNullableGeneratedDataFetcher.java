...
import fake.code.generated.queries.QueryQueryNonNullableDBQueries;
...
public class QueryQueryNonNullableGeneratedDataFetcher {
    public static DataFetcher<CompletableFuture<DummyType>> queryNonNullable() {
        return env -> {
            ...
            return new DataFetcherHelper(env).load(
                    (ctx, selectionSet) -> QueryQueryNonNullableDBQueries.queryNonNullableForQuery(ctx, id, str, bool, i, e, in, idList, inList, selectionSet)
            );
        };
    }
}