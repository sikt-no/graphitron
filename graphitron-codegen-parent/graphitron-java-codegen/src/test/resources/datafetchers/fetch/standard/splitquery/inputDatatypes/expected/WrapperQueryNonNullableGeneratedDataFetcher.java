...
import fake.code.generated.queries.WrapperQueryNonNullableDBQueries;
...
public class WrapperQueryNonNullableGeneratedDataFetcher {
    public static DataFetcher<CompletableFuture<DummyType>> queryNonNullable() {
        return env -> {
            ...
            return new DataFetcherHelper(env).load(
                    ...
                    (ctx, resolverKeys, selectionSet) -> WrapperQueryNonNullableDBQueries.queryNonNullableForWrapper(ctx, resolverKeys, id, str, bool, i, e, in, idList, inList, selectionSet)
            );
        };
    }
}
