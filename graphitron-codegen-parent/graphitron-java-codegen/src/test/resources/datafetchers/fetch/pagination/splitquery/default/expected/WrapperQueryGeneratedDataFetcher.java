    ...
    public static DataFetcher<CompletableFuture<DummyConnection>> query() {
        return env -> {
            ...
            return new DataFetcherHelper(env).loadPaginated(
                    ...
                    (ctx, resolverKeys, selectionSet) -> WrapperQueryDBQueries.queryForWrapper(ctx, resolverKeys, pageSize, after, selectionSet),
                    (ctx, resolverKeys) -> WrapperQueryDBQueries.countQueryForWrapper(ctx, resolverKeys),
                    (connection) ->  {
