...
import fake.code.generated.queries.QueryNodeCustomerDBQueries;
...
public class QueryNodeGeneratedDataFetcher {
    ...
    public static DataFetcher<CompletableFuture<Node>> node(NodeIdStrategy nodeIdStrategy) {
        return env -> {
            ...
            switch (_typeId) {
                case "Customer": return _fetcher.loadInterface(_loaderName, id, (ctx, ids, selectionSet) -> QueryNodeCustomerDBQueries.customerForNode(ctx, nodeIdStrategy, ids, selectionSet));
