    ...
    public static List<Address> toGraphType(List<MapperNestedJavaRecord> _mi_mapperNestedJavaRecord,
        ...
        if (_mi_mapperNestedJavaRecord != null) {
            for (var _nit_mapperNestedJavaRecord : _mi_mapperNestedJavaRecord) {
                ...
                var _mi_dummyRecord = _nit_mapperNestedJavaRecord.getDummyRecord();
                if (_mi_dummyRecord != null && _iv_select.contains(_iv_pathHere + "dummyRecord")) {
                    _mo_address.setDummyRecord(_iv_transform.dummyTypeRecordToGraphType(_mi_dummyRecord, _iv_pathHere + "dummyRecord"));
                }
