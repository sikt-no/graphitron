...
public class CustomerDBQueries {
    public static Map<CustomerRecord, Address> addressForCustomer(DSLContext _iv_ctx,
                                                                  NodeIdStrategy _iv_nodeIdStrategy, Set<CustomerRecord> _rk_customer,
        ...
        return _iv_ctx
                .select(
                        DSL.row(_a_customer.CUSTOMER_ID).convertFrom(_iv_it -> QueryHelper.intoTableRecord(_iv_it, List.of(_a_customer.CUSTOMER_ID))),
                        DSL.field(
