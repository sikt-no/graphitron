...
public class CustomerDBQueries {
    public static Map<Row1<Long>, Address> addressForCustomer(DSLContext ctx,
        ...
        return ctx
                .select(
                        ...
                        DSL.field(
                                DSL.select(addressForCustomer_address(_a_customer_2168032777_address, nodeIdStrategy))
    ...
    private static SelectField<Address> addressForCustomer_address(
            no.sikt.graphitron.jooq.generated.testdata.public_.tables.Address _a_customer_2168032777_address,
            NodeIdStrategy nodeIdStrategy) {
        return DSL.row(nodeIdStrategy.createId("Address", _a_customer_2168032777_address.fields(_a_customer_2168032777_address.getPrimaryKey().getFieldsArray()))).mapping(Functions.nullOnAllNull(Address::new));
    }
}