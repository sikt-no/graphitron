...
public class PaymentDBQueries {
    public static Map<PaymentRecord, List<PersonWithEmail>> staffAndCustomersForPayment(
            DSLContext _iv_ctx, Set<PaymentRecord> _rk_payment, SelectionSet _iv_select) {
