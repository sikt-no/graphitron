...
class TableMethodFieldValidationTest {
    ...
    enum Case implements ValidatorCase {
        ...
        UNRESOLVED_KEY("key name specified but FK could not be found in the jOOQ catalog",
            new TableMethodField("Film", "filteredActors", null, new ReturnTypeRef.OtherReturnType("Film", new FieldWrapper.Single(true)), List.of(new UnresolvedKeyRef("FILM_ACTOR_FK"))),
