...
public class ResolverTest extends GeneratorTest {
    ...
    void withContextCondition() {
        assertGeneratedContentContains(
                ...
                "queryForQuery(ctx, _ctxField, selectionSet)"
        );
    }

    @Test
    @DisplayName("Paginated field with a condition referencing a context parameter")
    void withContextConditionAndPagination() {
        assertGeneratedContentContains(
                "operation/withContextCondition",
                "_ctxField = ((String) _graphCtx.get(\"ctxField\"))",
                "queryForQuery(ctx, _ctxField, selectionSet)"
    ...
    void withArgumentContextCondition() {
        assertGeneratedContentContains(
                ...
                "_ctxField = ((String) _graphCtx.get(\"ctxField\"))",
                "queryForQuery(ctx, email, _ctxField, selectionSet)"
        );
    }
    ...
    void withInputTypeContextCondition() {
        assertGeneratedContentContains(
                ...
                "_ctxField = ((String) _graphCtx.get(\"ctxField\"))",
                "queryForQuery(ctx, in, _ctxField, selectionSet)"
        );
    }
    ...
    void withMultipleContextConditions() {
        assertGeneratedContentContains(
                ...
                "_ctxField1 = ((String) _graphCtx.get(\"ctxField1\"))",
                "_ctxField2 = ((String) _graphCtx.get(\"ctxField2\"))",
                "queryForQuery(ctx, email, _ctxField1, _ctxField2, selectionSet)"
        );
    }
