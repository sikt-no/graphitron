...
public class NodeDirectiveTest extends GeneratorTest {
    ...
    void nodeQuery() {
        assertGeneratedContentContains(
                ...
                "nodeIdStrategy.createId(\"Customer\", _a_customer.fields(_a_customer.getPrimaryKey().getFieldsArray())), nodeForCustomer_customer(_iv_nodeIdStrategy)",
    ...
    void customKeyColumnsInNodeQuery() {
        assertGeneratedContentContains(
                ...
                "nodeIdStrategy.createId(\"Customer\", _a_customer.CUSTOMER_ID, _a_customer.EMAIL), nodeForCustomer_customer(_iv_nodeIdStrategy)",
