...
public class DeleteMutationTest extends ValidationTest {
    ...
    @Test
    @DisplayName("Only errors field and no data fields should throw error")
    ...
    @Test
    @DisplayName("Only error/exception union field (with non-reserved name) and no data fields should throw error")
