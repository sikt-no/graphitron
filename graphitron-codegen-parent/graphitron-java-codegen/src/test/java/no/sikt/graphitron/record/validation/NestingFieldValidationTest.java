...
import no.sikt.graphitron.record.field.NestingField;
...
class NestingFieldValidationTest {
    ...
    enum Case implements ValidatorCase {
        ...
        VALID {
            public GraphitronField field() {
                return new NestingField(fieldOf("nested", typeRef("FilmDetails")));
            }
    ...
    void nestingFieldValidation(Case tc) {
        assertThat(validate(inTableTypeSchema("Film", "nested", tc.field())))
