...
public class MapperNodeStrategyTest extends GeneratorTest {
    ...
    void toRecord() {
        assertGeneratedContentContains("toRecord/default", Set.of(CUSTOMER_NODE),
                ...
                "customerInputTableToJOOQRecord(List<CustomerInputTable> _mi_input, NodeIdStrategy _iv_nodeIdStrategy, ArgumentPresence _iv_argPresence, String _iv_path)",
                "customerInputTableToJOOQRecord(CustomerInputTable _mi_input, NodeIdStrategy _iv_nodeIdStrategy, ArgumentPresence _iv_argPresence, String _iv_path)",
                "customerInputTableToJOOQRecord(List.of(_mi_input), _iv_nodeIdStrategy, _iv_argPresence.asSingleItem(), _iv_path)",
