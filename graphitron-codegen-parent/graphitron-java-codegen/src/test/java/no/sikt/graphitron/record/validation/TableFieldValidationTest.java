...
class TableFieldValidationTest {
    ...
    enum Case implements ValidatorCase {
        ...
        NO_PATH("no @reference — FK auto-inference will be attempted at code-generation time",
            new TableField("actors", null, List.of(), new FieldConditionStep.NoFieldCondition(), null),
            List.of()),

        WITH_FK_PATH("explicit FK path — key resolved to a jOOQ ForeignKey",
            new TableField("actors", null, List.of(new FkStep(Keys.FILM_ACTOR__FILM_ACTOR_FILM_ID_FKEY)), new FieldConditionStep.NoFieldCondition(), null),
            List.of()),
        ...
        WITH_FK_AND_CONDITION("FK + resolved condition method in reference path",
            new TableField("actors", null, List.of(
                new FkWithConditionStep(Keys.FILM_ACTOR__FILM_ACTOR_FILM_ID_FKEY,
                    new MethodRef("com.example.Conditions.actorCondition", "org.jooq.Condition", List.of()))), new FieldConditionStep.NoFieldCondition(), null),
            List.of()),

        WITH_CONDITION_ONLY("condition method only — no FK",
            new TableField("actors", null, List.of(
                new ConditionOnlyStep(new MethodRef("com.example.Conditions.actorCondition", "org.jooq.Condition", List.of()))), new FieldConditionStep.NoFieldCondition(), null),
            List.of()),

        UNRESOLVED_KEY("key name specified but FK could not be found in the jOOQ catalog",
            new TableField("actors", null, List.of(new UnresolvedKeyStep("FILM_ACTOR_FK")), new FieldConditionStep.NoFieldCondition(), null),
        ...
        UNRESOLVED_CONDITION("condition method present but could not be resolved via reflection",
            new TableField("actors", null, List.of(
                new UnresolvedConditionStep("com.example.Conditions.actorCondition")), new FieldConditionStep.NoFieldCondition(), null),
        ...
        UNRESOLVED_KEY_AND_CONDITION("both key and condition specified, neither could be resolved — two errors",
            new TableField("actors", null, List.of(
                new UnresolvedKeyAndConditionStep("FILM_ACTOR_FK", "com.example.Conditions.actorCondition")), new FieldConditionStep.NoFieldCondition(), null),
            List.of(
        ...
        FIELD_CONDITION_RESOLVED("resolved @condition on field — adds WHERE clause; no errors",
            new TableField("actors", null, List.of(), new FieldConditionStep.ResolvedFieldCondition(
                new MethodRef("com.example.Conditions.actorCondition", "org.jooq.Condition", List.of()), false, List.of()), null),
            List.of()),

        FIELD_CONDITION_RESOLVED_OVERRIDE("resolved @condition with override:true — no errors",
            new TableField("actors", null, List.of(), new FieldConditionStep.ResolvedFieldCondition(
                new MethodRef("com.example.Conditions.actorCondition", "org.jooq.Condition", List.of()), true, List.of()), null),
            List.of()),
        ...
        FIELD_CONDITION_UNRESOLVED("unresolved @condition method on field — validation error",
            new TableField("actors", null, List.of(), new FieldConditionStep.UnresolvedFieldCondition(
                "com.example.Conditions.missingCondition", false, List.of()), null),
        ...
        DEFAULT_ORDER_FIELDS("@defaultOrder with explicit fields — valid",
            new TableField("actors", null, List.of(), new FieldConditionStep.NoFieldCondition(),
                new DefaultOrderSpec(
                    new OrderSpec.FieldsOrder(List.of(new SortFieldSpec("actor_id", null))), "ASC")),
            List.of()),

        DEFAULT_ORDER_INDEX("@defaultOrder with named index — valid",
            new TableField("actors", null, List.of(), new FieldConditionStep.NoFieldCondition(),
                new DefaultOrderSpec(new OrderSpec.IndexOrder("IDX_ACTOR_LAST_NAME"), "ASC")),
            List.of()),

        DEFAULT_ORDER_PRIMARY_KEY("@defaultOrder with primaryKey mode — valid",
            new TableField("actors", null, List.of(), new FieldConditionStep.NoFieldCondition(),
                new DefaultOrderSpec(new OrderSpec.PrimaryKeyOrder(), "ASC")),
            List.of()),
        ...
        DEFAULT_ORDER_UNRESOLVED_PRIMARY_KEY("@defaultOrder uses primaryKey but the table has none — validation error",
            new TableField("actors", null, List.of(), new FieldConditionStep.NoFieldCondition(),
                new DefaultOrderSpec(new OrderSpec.UnresolvedPrimaryKeyOrder(), "ASC")),
