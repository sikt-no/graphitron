...
class TableFieldValidationTest {
    ...
    enum Case implements ValidatorCase {
        ...
        NO_PATH("no @reference — FK auto-inference will be attempted at code-generation time",
            new TableField("Film", "actors", null, List.of(), new FieldConditionRef.NoFieldCondition(), false, new FieldCardinality.Single()),
            List.of()),

        WITH_FK_PATH("explicit FK path — key resolved to a jOOQ ForeignKey",
            new TableField("Film", "actors", null, List.of(new FkRef(Keys.FILM_ACTOR__FILM_ACTOR_FILM_ID_FKEY)), new FieldConditionRef.NoFieldCondition(), false, new FieldCardinality.Single()),
            List.of()),
        ...
        UNRESOLVED_KEY("key name specified but FK could not be found in the jOOQ catalog",
            new TableField("Film", "actors", null, List.of(new UnresolvedKeyRef("FILM_ACTOR_FK")), new FieldConditionRef.NoFieldCondition(), false, new FieldCardinality.Single()),
        ...
        FIELD_CONDITION_RESOLVED("resolved @condition on field — adds WHERE clause; no errors",
            new TableField("Film", "actors", null, List.of(), new FieldConditionRef.ResolvedFieldCondition(
        ...
        FIELD_CONDITION_UNRESOLVED("unresolved @condition method on field — validation error",
            new TableField("Film", "actors", null, List.of(), new FieldConditionRef.UnresolvedFieldCondition(
