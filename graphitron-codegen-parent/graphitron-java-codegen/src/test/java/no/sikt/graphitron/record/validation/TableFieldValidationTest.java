...
class TableFieldValidationTest {
    ...
    enum Case implements ValidatorCase {
        ...
        NO_PATH("no @reference — FK auto-inference will be attempted at code-generation time",
            new TableField("actors", null, List.of(), new FieldConditionStep.NoFieldCondition(), new FieldCardinality.Single()),
            List.of()),

        WITH_FK_PATH("explicit FK path — key resolved to a jOOQ ForeignKey",
            new TableField("actors", null, List.of(new FkStep(Keys.FILM_ACTOR__FILM_ACTOR_FILM_ID_FKEY)), new FieldConditionStep.NoFieldCondition(), new FieldCardinality.Single()),
            List.of()),
        ...
        UNRESOLVED_KEY("key name specified but FK could not be found in the jOOQ catalog",
            new TableField("actors", null, List.of(new UnresolvedKeyStep("FILM_ACTOR_FK")), new FieldConditionStep.NoFieldCondition(), new FieldCardinality.Single()),
