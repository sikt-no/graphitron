...
import no.sikt.graphitron.record.field.UnionQueryField;
...
class UnionQueryFieldValidationTest {
    ...
    enum Case implements ValidatorCase {
        ...
        VALID {
            public GraphitronField field() {
                return new UnionQueryField(fieldOf("search", list(typeRef("SearchResult"))));
            }
    ...
    void unionQueryFieldValidation(Case tc) {
        assertThat(validate(inQuerySchema("search", tc.field())))
