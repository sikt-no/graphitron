...
import no.sikt.graphitron.record.field.QueryField.UnionQueryField;
...
class UnionQueryFieldValidationTest {
    ...
    enum Case implements ValidatorCase {
        ...
        VALID("single cardinality — valid",
            new UnionQueryField("Query", "search", null, new ReturnTypeRef.OtherReturnType("Film"), new FieldCardinality.Single()),
            List.of()),
