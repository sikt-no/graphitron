...
import no.sikt.graphitron.record.field.QueryField.InterfaceQueryField;
...
class InterfaceQueryFieldValidationTest {
    ...
    enum Case implements ValidatorCase {
        ...
        VALID("single cardinality — valid",
            new InterfaceQueryField("Query", "persons", null, new ReturnTypeRef.OtherReturnType("Film"), new FieldCardinality.Single()),
            List.of()),
