...
import no.sikt.graphitron.record.field.InterfaceQueryField;
...
class InterfaceQueryFieldValidationTest {
    ...
    enum Case implements ValidatorCase {
        ...
        VALID {
            public GraphitronField field() {
                return new InterfaceQueryField(fieldOf("persons", list(typeRef("Person"))));
            }
    ...
    void interfaceQueryFieldValidation(Case tc) {
        assertThat(validate(inQuerySchema("persons", tc.field())))
