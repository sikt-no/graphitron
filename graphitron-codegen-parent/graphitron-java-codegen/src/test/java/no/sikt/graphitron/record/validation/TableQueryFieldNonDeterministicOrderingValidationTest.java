...
class TableQueryFieldNonDeterministicOrderingValidationTest {
    ...
    enum Case {
        ...
        SINGLE_CARDINALITY(
            "single cardinality field — ordering is irrelevant, no error",
        ...
        private final TableQueryField field;
        private final TableType returnType;
        private final List<String> errors;

        Case(String description, TableQueryField field, TableType returnType, List<String> errors) {
    ...
    void nonDeterministicOrderingValidation(Case tc) {
        assertThat(validate(inQuerySchemaWithReturnType("films", tc.field, tc.returnType)))
