    ...
    enum Case implements ValidatorCase {
        ...
        IMPLICIT_SINGLE_FK("exactly one FK between tables — implicit join, no errors",
            new NodeIdReferenceField("Inventory", "filmId", null, "Film",
                new ReturnTypeRef.TableBoundReturnType("Film", new ResolvedTable("film", "FILM", "Film", true), new FieldWrapper.Single(true)),
                new ResolvedTable("inventory", "INVENTORY", "Inventory", true),
                NODE,
                List.of()),
            List.of()),
        ...
        IMPLICIT_NO_FK("no FK between tables — error suggesting @reference",
            new NodeIdReferenceField("Film", "categoryId", null, "Category",
                new ReturnTypeRef.TableBoundReturnType("Category", new ResolvedTable("category", "CATEGORY", "Category", true), new FieldWrapper.Single(true)),
                new ResolvedTable("film", "FILM", "Film", true),
                NODE,
                List.of()),
        ...
        IMPLICIT_MULTIPLE_FKS("multiple FKs between tables — error suggesting @reference",
            new NodeIdReferenceField("Film", "languageId", null, "Language",
                new ReturnTypeRef.TableBoundReturnType("Language", new ResolvedTable("language", "LANGUAGE", "Language", true), new FieldWrapper.Single(true)),
                new ResolvedTable("film", "FILM", "Film", true),
                NODE,
                List.of()),
