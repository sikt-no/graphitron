...
class RecordLookupTableFieldValidationTest {
    ...
    enum Case implements ValidatorCase {
        ...
        VALID_SINGLE("single return — valid",
            new RecordLookupTableField("Language", "film", null, filmReturn(new FieldWrapper.Single(true)), List.of(), List.of()),
            List.of()),

        VALID_LIST("list return — valid",
            new RecordLookupTableField("Language", "films", null, filmReturn(new FieldWrapper.List(true, true, null, List.of())), List.of(), List.of()),
            List.of()),

        CONNECTION_BLOCKED("connection return — not valid on lookup field",
            new RecordLookupTableField("Language", "films", null, filmReturn(new FieldWrapper.Connection(true, true, null, List.of())), List.of(), List.of()),
