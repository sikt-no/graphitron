...
public final class JavaFileTest {
    ...
    public void avoidClashesWithNestedClasses_viaSuperinterfaceType() {
        ...
        assertThat(source).isEqualTo("package com.squareup.tacos;\n"
                + "\n"
                + "import no.sikt.graphitron.javapoet.JavaFileTest;\n"
                + "import other.Foo;\n"
                + "import other.NestedTypeC;\n"
                + "\n"
    ...
    public void avoidClashes_parentChild_superclass_type() {
        String source = JavaFile.builder("no.sikt.graphitron.javapoet",
                        childTypeBuilder().superclass(Parent.class).build())
                .build()
                .toString();
        assertThat(source).isEqualTo("package no.sikt.graphitron.javapoet;\n"
                + "\n"
                + "import java.lang.String;\n"
                + "\n"
