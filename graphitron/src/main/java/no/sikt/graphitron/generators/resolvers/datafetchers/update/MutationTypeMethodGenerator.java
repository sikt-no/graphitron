 ...
 */
public class MutationTypeMethodGenerator extends UpdateMethodGenerator {
    private static final String VARIABLE_ROWS = "rowsUpdated";

    public MutationTypeMethodGenerator(ObjectField localField, ProcessedSchema processedSchema) {
    ...
    protected CodeBlock transformInputs(List<? extends InputField> inputs, boolean hasRecords) {
        ...
        return super.transformInputs(inputs, parser.hasRecords());
    }
    ...
    protected CodeBlock generateSchemaOutputs(ObjectField target) {
        ...
        return CodeBlock
                .builder()
                .add(makeResponses(mapperContext, localField, processedSchema, parser))  // Note: Moved this out to reduce code duplication with new DataFetchers.
