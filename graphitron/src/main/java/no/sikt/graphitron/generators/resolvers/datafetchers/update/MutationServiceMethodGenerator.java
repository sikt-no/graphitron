 ...
 */
public class MutationServiceMethodGenerator extends UpdateMethodGenerator {
    private boolean serviceReturnEndsWithRecord;

    public MutationServiceMethodGenerator(ObjectField localField, ProcessedSchema processedSchema) {
