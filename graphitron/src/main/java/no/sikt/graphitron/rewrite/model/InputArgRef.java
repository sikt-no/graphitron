 ...
 *
 * <p>Deliberately a separate slot from the verb-specific carrier ({@link UpdateRows} /
 * {@link DeleteRows}): every DML walker-carrier verb reuses the same arg surface, so the slot
 * lands once here and rides the {@link OperationMember.Write.Update} and
 * {@link OperationMember.Write.Delete} arms. The emitter reads {@link #name()} to pull the argument
