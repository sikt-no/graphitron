 ...
 * column axis (a {@link CallSiteExtraction.JooqRecord}). Minted by {@code InputBeanResolver}, not by
    ...
    JooqRecordInputError.LiveColumnCollision
{
     ...
     * classifier merges the group into a single {@link CallSiteExtraction.ColumnBinding} with ordered
