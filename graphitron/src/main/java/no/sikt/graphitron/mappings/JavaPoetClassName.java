...
public enum JavaPoetClassName {
    ...
    DATA_FETCHER_GRAPHITRON(ClassName.get(DataFetcher.class)),
    DATA_FETCHER(ClassName.get(graphql.schema.DataFetcher.class)),
    ...
    STREAM(ClassName.get(java.util.stream.Stream.class)),
