 ...
 * {@code (DSLContext)} constructor. Used to pin the rejection path
 * {@link ServiceCatalog#decodeServiceMethod} captures, and
 * {@link ServiceCatalog#bindServiceMethod} surfaces, when an instance method's holder cannot
 * be constructed by the emitter.
 */
