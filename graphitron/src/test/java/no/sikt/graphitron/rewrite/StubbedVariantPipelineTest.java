...
class StubbedVariantPipelineTest {
    ...
    // BatchedTableField / BatchedLookupTableField intra-variant stub paths are exercised via
    // BatchedTableFieldValidationTest / BatchedLookupTableFieldValidationTest with
