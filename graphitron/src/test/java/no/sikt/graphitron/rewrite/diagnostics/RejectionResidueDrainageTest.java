...
class RejectionResidueDrainageTest {
    ...
    private static final Set<String> RESIDUE_LEAVES = Set.of(
        ...
        "ReflectionError.HandleTypeMismatch", "ReflectionError.TenantSlotDuplicated",
        "ReflectionError.TenantSlotMistyped",
        "UpdateRowsError.NoUniqueKeyCoverage", "UpdateRowsError.NoSetFields",
        "UpdateRowsError.MixedCarrierKeyMembership", "UpdateRowsError.NullableStraddlingReference",
