...
/**
 * SettKvotesporsmal-shape regression fixture: a top-level record-backed payload
 ...
 *
 * <p>Previously, the carrier walk's forbidden-directives loop hard-rejected
 ...
 * inner table's record class instead of the payload class). The unified path retires the carrier
 * walk's involvement from both forms; both classify identically through it.
 */
