package no.fellesstudentsystem.graphitron.resolvers.services.edit;
...
import static no.fellesstudentsystem.graphitron.common.configuration.ReferencedEntry.RESOLVER_MUTATION_SERVICE;
...
public class ResolverTest extends GeneratorTest {
    ...
    protected String getSubpath() {
        return "resolvers/edit/services";
    }
    ...
    void undefinedServiceMethod() {
        assertThatThrownBy(() -> generateFiles("undefinedServiceMethod"))
                ...
                .hasMessageContaining("Service reference no.fellesstudentsystem.graphitron.codereferences.services.ResolverMutationService does not contain method named UNDEFINED");
    }
