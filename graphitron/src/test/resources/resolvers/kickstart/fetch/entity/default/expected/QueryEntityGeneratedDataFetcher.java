...
import graphql.schema.DataFetcherHelper;
import org.jooq.DSLContext;

public class QueryEntityGeneratedDataFetcherHelper {
    public static DataFetcherHelper<List<Map<String, Object>>> entityFetcher() {
