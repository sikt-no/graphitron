...
COMMENT ON COLUMN intent_routine_return_binding.type_name IS 'the type this row binds: the returning field''s authored named type with its list and non-null wrappers stripped';
