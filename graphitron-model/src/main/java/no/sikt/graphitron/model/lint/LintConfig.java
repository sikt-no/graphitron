 ...
 * and threaded through {@link no.sikt.graphitron.model.config.RunContext} so suppression is applied at
 ...
 * <ul>
 *   <li>{@code disabledRuleIds} drops any {@link no.sikt.graphitron.model.diagnostics.BuildWarning.LintFinding}
