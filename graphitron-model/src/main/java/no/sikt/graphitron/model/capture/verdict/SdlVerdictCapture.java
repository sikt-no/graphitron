 ...
 */
public final class SdlVerdictCapture {
     ...
     */
    public static void capture(FactSink sink, SdlVerdicts verdicts, SchemaAssembly assembly) {
     ...
     */
    private static void writeSyntaxError(FactSink sink, SchemaLoader.SyntaxFailure failure) {
