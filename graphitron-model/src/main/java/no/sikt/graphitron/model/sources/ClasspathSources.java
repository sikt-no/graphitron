...
public final class ClasspathSources {
     ...
     */
    public String record(FactSink sink, String sourceName) {
     ...
     */
    public static void upsert(DSLContext dsl, String sourceName, String sourceKind) {
     ...
     */
    public void noteRegularFile(Path path) {
        recorded.add(path);
    }
     ...
     * writer stored.
     */
    public static String hash(Path entry) {
