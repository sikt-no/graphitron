...
/**
 * Thrown by {@link no.sikt.graphitron.model.schema.SchemaLoader#load} when the GraphQL
 ...
 * {@code SchemaLoader} builds, so a generic {@code catch (RuntimeException)} site (the
