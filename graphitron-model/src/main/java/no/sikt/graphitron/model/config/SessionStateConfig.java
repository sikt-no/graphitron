 ...
 * and threaded through {@link no.sikt.graphitron.model.config.RunContext} into the schema build.
 *
 ...
 * readers, {@code SessionStateWarnings#forConfig} and fact capture's transcription; every
