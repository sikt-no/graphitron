...
/**
 * Thrown by {@code GraphQLRewriteGenerator#generate()} and {@code GraphQLRewriteGenerator#validate()}
 * when {@code GraphitronSchemaValidator} returns a non-empty error list. Carries the structured
 ...
 * {@code GraphQLRewriteGenerator#runPass()} returns the same errors on its report and logs none of
