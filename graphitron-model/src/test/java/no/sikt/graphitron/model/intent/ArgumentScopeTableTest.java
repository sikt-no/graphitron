...
/**
 * What {@code graphitron_argument_scope_table} resolves: the table an argument's column-shaped content
...
class ArgumentScopeTableTest {
    ...
    private static String render(Record row) {
        return row.get(GRAPHITRON_ARGUMENT_SCOPE_TABLE.TYPE_NAME) + "."
