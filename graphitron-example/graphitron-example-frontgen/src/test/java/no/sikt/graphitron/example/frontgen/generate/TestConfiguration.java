...
public class TestConfiguration {
    public static final String
            ...
            DEFAULT_JOOQ_PACKAGE = "no.sikt.graphitron.example.generated.jooq",
    ...
    @NotNull
    public static ProcessedSchema getProcessedSchema(String schemaPath, boolean validate, boolean checkTypes) {
        var files =
                Stream.of(SRC_DIRECTIVES, schemaPath + "/" + COMMON_TEST_SCHEMA_NAME).collect(Collectors.toSet());
