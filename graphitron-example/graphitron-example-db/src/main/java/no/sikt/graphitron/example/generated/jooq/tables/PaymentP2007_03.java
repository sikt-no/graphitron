...
public class PaymentP2007_03 extends TableImpl<PaymentP2007_03Record> {
     ...
     */
    public final TableField<PaymentP2007_03Record, Integer> CUSTOMER_ID = createField(DSL.name("customer_id"), SQLDataType.SMALLINT.nullable(false), this, "", new ShortToIntegerConverter());

    /**
     * The column <code>public.payment_p2007_03.staff_id</code>.
     */
    public final TableField<PaymentP2007_03Record, Integer> STAFF_ID = createField(DSL.name("staff_id"), SQLDataType.SMALLINT.nullable(false), this, "", new ShortToIntegerConverter());
    ...
    public <O extends Record> PaymentP2007_03(Table<O> path, ForeignKey<O, PaymentP2007_03Record> childPath, InverseForeignKey<O, PaymentP2007_03Record> parentPath) {
    ...
    public List<ForeignKey<PaymentP2007_03Record, ?>> getReferences() {
        return Arrays.asList(Keys.PAYMENT_P2007_03__PAYMENT_P2007_03_CUSTOMER_ID_FKEY, Keys.PAYMENT_P2007_03__PAYMENT_P2007_03_RENTAL_ID_FKEY, Keys.PAYMENT_P2007_03__PAYMENT_P2007_03_STAFF_ID_FKEY);
    }
    ...
    public RentalPath rental() {
        if (_rental == null)
            _rental = new RentalPath(this, Keys.PAYMENT_P2007_03__PAYMENT_P2007_03_RENTAL_ID_FKEY, null);
