...
public class PaymentP2007_05 extends TableImpl<PaymentP2007_05Record> {
     ...
     */
    public final TableField<PaymentP2007_05Record, Integer> CUSTOMER_ID = createField(DSL.name("customer_id"), SQLDataType.SMALLINT.nullable(false), this, "", new ShortToIntegerConverter());

    /**
     * The column <code>public.payment_p2007_05.staff_id</code>.
     */
    public final TableField<PaymentP2007_05Record, Integer> STAFF_ID = createField(DSL.name("staff_id"), SQLDataType.SMALLINT.nullable(false), this, "", new ShortToIntegerConverter());
    ...
    public List<ForeignKey<PaymentP2007_05Record, ?>> getReferences() {
        return Arrays.asList(Keys.PAYMENT_P2007_05__PAYMENT_P2007_05_CUSTOMER_ID_FKEY, Keys.PAYMENT_P2007_05__PAYMENT_P2007_05_RENTAL_ID_FKEY, Keys.PAYMENT_P2007_05__PAYMENT_P2007_05_STAFF_ID_FKEY);
    }
