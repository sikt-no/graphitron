...
import no.sikt.graphitron.example.generated.jooq.tables.City.CityPath;
...
public class Address extends TableImpl<AddressRecord> {
     ...
     */
    public final TableField<AddressRecord, Integer> CITY_ID = createField(DSL.name("city_id"), SQLDataType.SMALLINT.nullable(false), this, "", new ShortToIntegerConverter());
