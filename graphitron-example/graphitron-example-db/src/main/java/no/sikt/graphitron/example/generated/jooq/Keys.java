...
import no.sikt.graphitron.example.generated.jooq.tables.records.CategoryRecord;
import no.sikt.graphitron.example.generated.jooq.tables.records.CityRecord;
import no.sikt.graphitron.example.generated.jooq.tables.records.CountryRecord;
...
import no.sikt.graphitron.example.generated.jooq.tables.records.PaymentP2007_01Record;
import no.sikt.graphitron.example.generated.jooq.tables.records.PaymentP2007_02Record;
import no.sikt.graphitron.example.generated.jooq.tables.records.PaymentP2007_03Record;
import no.sikt.graphitron.example.generated.jooq.tables.records.PaymentP2007_04Record;
import no.sikt.graphitron.example.generated.jooq.tables.records.PaymentP2007_05Record;
import no.sikt.graphitron.example.generated.jooq.tables.records.PaymentP2007_06Record;
...
import no.sikt.graphitron.example.generated.jooq.tables.records.StaffRecord;
import no.sikt.graphitron.example.generated.jooq.tables.records.StoreRecord;
...
public class Keys {
    ...
    public static final ForeignKey<FilmRecord, FilmRecord> FILM__SEQUEL_FKEY = Internal.createForeignKey(Film.FILM, DSL.name("sequel_fkey"), new TableField[] { Film.FILM.SEQUEL }, Keys.FILM_PKEY, new TableField[] { Film.FILM.FILM_ID }, true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION);
