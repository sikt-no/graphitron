...
import no.sikt.graphitron.example.generated.jooq.tables.Address.AddressPath;
...
public class Staff extends TableImpl<StaffRecord> {
     ...
     */
    public final TableField<StaffRecord, Integer> ADDRESS_ID = createField(DSL.name("address_id"), SQLDataType.SMALLINT.nullable(false), this, "", new ShortToIntegerConverter());
     ...
     */
    public final TableField<StaffRecord, Integer> STORE_ID = createField(DSL.name("store_id"), SQLDataType.SMALLINT.nullable(false), this, "", new ShortToIntegerConverter());
    ...
    public java.util.List<TableField<no.sikt.graphitron.example.generated.jooq.tables.records.StaffRecord, ?>> getIdFields() {
        return java.util.List.of(STAFF_ID);
    }
    ...
    private static final java.util.Map<String, String> qualifiers = java.util.Map.ofEntries(
        java.util.Map.entry("staff_address_id_fkey", "AddressId"),
        java.util.Map.entry("staff_store_id_fkey", "StoreId")
    );
