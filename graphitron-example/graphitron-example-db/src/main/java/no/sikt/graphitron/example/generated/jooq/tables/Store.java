...
public class Store extends TableImpl<StoreRecord> {
     ...
     */
    public final TableField<StoreRecord, Integer> MANAGER_STAFF_ID = createField(DSL.name("manager_staff_id"), SQLDataType.SMALLINT.nullable(false), this, "", new ShortToIntegerConverter());

    /**
     * The column <code>public.store.address_id</code>.
     */
    public final TableField<StoreRecord, Integer> ADDRESS_ID = createField(DSL.name("address_id"), SQLDataType.SMALLINT.nullable(false), this, "", new ShortToIntegerConverter());
