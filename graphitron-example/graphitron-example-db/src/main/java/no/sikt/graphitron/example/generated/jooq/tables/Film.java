...
import no.sikt.graphitron.example.generated.jooq.Domains;
...
import no.sikt.graphitron.example.generated.jooq.tables.FilmCategory.FilmCategoryPath;
import no.sikt.graphitron.example.generated.jooq.tables.Inventory.InventoryPath;
import no.sikt.graphitron.example.generated.jooq.tables.Language.LanguagePath;
...
public class Film extends TableImpl<FilmRecord> {
     ...
     */
    public final TableField<FilmRecord, Integer> LANGUAGE_ID = createField(DSL.name("language_id"), SQLDataType.SMALLINT.nullable(false), this, "", new ShortToIntegerConverter());

    /**
     * The column <code>public.film.original_language_id</code>.
     */
    public final TableField<FilmRecord, Integer> ORIGINAL_LANGUAGE_ID = createField(DSL.name("original_language_id"), SQLDataType.SMALLINT, this, "", new ShortToIntegerConverter());

    /**
     * The column <code>public.film.rental_duration</code>.
     */
    public final TableField<FilmRecord, Integer> RENTAL_DURATION = createField(DSL.name("rental_duration"), SQLDataType.SMALLINT.nullable(false).defaultValue(DSL.field(DSL.raw("3"), SQLDataType.SMALLINT)), this, "", new ShortToIntegerConverter());
     ...
     */
    public final TableField<FilmRecord, Integer> LENGTH = createField(DSL.name("length"), SQLDataType.SMALLINT, this, "", new ShortToIntegerConverter());
    ...
    /**
     * The column <code>public.film.sequel</code>.
     */
    public final TableField<FilmRecord, Long> SEQUEL = createField(DSL.name("sequel"), SQLDataType.BIGINT, this, "");
    ...
    public List<ForeignKey<FilmRecord, ?>> getReferences() {
        return Arrays.asList(Keys.FILM__FILM_LANGUAGE_ID_FKEY, Keys.FILM__FILM_ORIGINAL_LANGUAGE_ID_FKEY, Keys.FILM__SEQUEL_FKEY);
    }
    ...
    public FilmPath film() {
        if (_film == null)
            _film = new FilmPath(this, Keys.FILM__SEQUEL_FKEY, null);
