...
public class Film extends TableImpl<FilmRecord> {
     ...
     */
    public final TableField<FilmRecord, Integer> RENTAL_DURATION = createField(DSL.name("rental_duration"), SQLDataType.SMALLINT.defaultValue(DSL.field(DSL.raw("3"), SQLDataType.SMALLINT)), this, "", new ShortToIntegerConverter());
