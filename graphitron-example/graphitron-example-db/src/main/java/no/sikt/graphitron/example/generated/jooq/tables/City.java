...
import no.sikt.graphitron.example.generated.jooq.tables.Country.CountryPath;
...
public class City extends TableImpl<CityRecord> {
     ...
     */
    public final TableField<CityRecord, Integer> COUNTRY_ID = createField(DSL.name("country_id"), SQLDataType.SMALLINT.nullable(false), this, "", new ShortToIntegerConverter());
