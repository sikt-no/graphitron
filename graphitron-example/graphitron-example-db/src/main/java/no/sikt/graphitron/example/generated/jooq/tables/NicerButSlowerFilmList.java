...
import no.sikt.graphitron.example.generated.jooq.tables.records.NicerButSlowerFilmListRecord;
...
public class NicerButSlowerFilmList extends TableImpl<NicerButSlowerFilmListRecord> {
     ...
     */
    public final TableField<NicerButSlowerFilmListRecord, Integer> LENGTH = createField(DSL.name("length"), SQLDataType.SMALLINT, this, "", new ShortToIntegerConverter());
