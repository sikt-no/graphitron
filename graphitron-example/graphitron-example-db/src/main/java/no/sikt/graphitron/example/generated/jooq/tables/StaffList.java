...
import no.sikt.graphitron.example.generated.jooq.tables.records.StaffListRecord;
...
public class StaffList extends TableImpl<StaffListRecord> {
     ...
     */
    public final TableField<StaffListRecord, Integer> SID = createField(DSL.name("sid"), SQLDataType.SMALLINT, this, "", new ShortToIntegerConverter());
