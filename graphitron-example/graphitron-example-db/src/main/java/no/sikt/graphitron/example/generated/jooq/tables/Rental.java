...
public class Rental extends TableImpl<RentalRecord> {
    ...
    public java.util.List<TableField<no.sikt.graphitron.example.generated.jooq.tables.records.RentalRecord, ?>> getIdFields() {
        return java.util.List.of(RENTAL_ID);
    }
    ...
    public org.jooq.SelectField<String> getInventoryId() {
        return DSL.row(INVENTORY_ID)
            .mapping(String.class, org.jooq.Functions.nullOnAnyNull((s0) -> s0.toString()))
            .as(DSL.name("inventory_id"));
    }

    public org.jooq.Condition hasInventoryId(String id) {
        return hasInventoryIds(java.util.Set.of(id));
    }

    public org.jooq.Condition hasInventoryIds(java.util.Set<String> ids) {
        var field = java.util.List.of(INVENTORY_ID).get(0);
        var converted = ids.stream().map(it -> field.getDataType().convert(it)).collect(java.util.stream.Collectors.toList());
        return field.in(converted);
    }
    ...
    private static final java.util.Map<String, String> qualifiers = java.util.Map.ofEntries(
        java.util.Map.entry("rental_customer_id_fkey", "CustomerId"),
        java.util.Map.entry("rental_inventory_id_fkey", "InventoryId"),
        java.util.Map.entry("rental_staff_id_fkey", "StaffId")
    );
