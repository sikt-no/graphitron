...
import no.sikt.graphitron.example.generated.jooq.tables.records.FilmListRecord;
...
public class FilmList extends TableImpl<FilmListRecord> {
     ...
     */
    public final TableField<FilmListRecord, Integer> LENGTH = createField(DSL.name("length"), SQLDataType.SMALLINT, this, "", new ShortToIntegerConverter());
