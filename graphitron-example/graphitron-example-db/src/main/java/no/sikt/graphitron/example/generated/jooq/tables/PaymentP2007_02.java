...
public class PaymentP2007_02 extends TableImpl<PaymentP2007_02Record> {
     ...
     */
    public final TableField<PaymentP2007_02Record, Integer> CUSTOMER_ID = createField(DSL.name("customer_id"), SQLDataType.SMALLINT.nullable(false), this, "", new ShortToIntegerConverter());

    /**
     * The column <code>public.payment_p2007_02.staff_id</code>.
     */
    public final TableField<PaymentP2007_02Record, Integer> STAFF_ID = createField(DSL.name("staff_id"), SQLDataType.SMALLINT.nullable(false), this, "", new ShortToIntegerConverter());
