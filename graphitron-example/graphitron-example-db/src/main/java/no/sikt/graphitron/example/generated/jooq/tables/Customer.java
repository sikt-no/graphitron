...
public class Customer extends TableImpl<CustomerRecord> {
     ...
     */
    public final TableField<CustomerRecord, Integer> STORE_ID = createField(DSL.name("store_id"), SQLDataType.SMALLINT.nullable(false), this, "", new ShortToIntegerConverter());
     ...
     */
    public final TableField<CustomerRecord, Integer> ADDRESS_ID = createField(DSL.name("address_id"), SQLDataType.SMALLINT.nullable(false), this, "", new ShortToIntegerConverter());
    ...
    private static final java.util.Map<String, String> qualifiers = java.util.Map.ofEntries(
        java.util.Map.entry("customer_address_id_fkey", "AddressId"),
        java.util.Map.entry("customer_store_id_fkey", "StoreId")
    );
