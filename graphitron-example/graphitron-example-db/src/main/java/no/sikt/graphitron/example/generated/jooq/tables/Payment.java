...
public class Payment extends TableImpl<PaymentRecord> {
     ...
     */
    public final TableField<PaymentRecord, Integer> CUSTOMER_ID = createField(DSL.name("customer_id"), SQLDataType.SMALLINT.nullable(false), this, "", new ShortToIntegerConverter());

    /**
     * The column <code>public.payment.staff_id</code>.
     */
    public final TableField<PaymentRecord, Integer> STAFF_ID = createField(DSL.name("staff_id"), SQLDataType.SMALLINT.nullable(false), this, "", new ShortToIntegerConverter());
    ...
    public org.jooq.Condition hasIds(java.util.Set<String> ids) {
        var field = java.util.List.of(PAYMENT_ID).get(0);
