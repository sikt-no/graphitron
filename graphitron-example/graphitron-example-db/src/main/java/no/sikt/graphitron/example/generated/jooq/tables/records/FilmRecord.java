...
public class FilmRecord extends UpdatableRecordImpl<FilmRecord> {
     ...
     */
    public FilmRecord(String filmId, String title, String description, Integer releaseYear, Short languageId, Short originalLanguageId, Short rentalDuration, BigDecimal rentalRate, Short length, BigDecimal replacementCost, MpaaRating rating, LocalDateTime lastUpdate, String[] specialFeatures, Object fulltext) {
        super(Film.FILM);
