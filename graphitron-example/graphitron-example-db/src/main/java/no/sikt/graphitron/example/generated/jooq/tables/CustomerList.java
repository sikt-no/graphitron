...
import no.sikt.graphitron.example.generated.jooq.tables.records.CustomerListRecord;
...
public class CustomerList extends TableImpl<CustomerListRecord> {
     ...
     */
    public final TableField<CustomerListRecord, Integer> SID = createField(DSL.name("sid"), SQLDataType.SMALLINT, this, "", new ShortToIntegerConverter());
