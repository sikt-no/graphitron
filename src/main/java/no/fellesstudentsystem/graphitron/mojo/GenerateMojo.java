...
public class GenerateMojo extends AbstractMojo {
    ...
    /**
     * Toggle which foreign key format (generated by JOOQ) Graphitron should expect to find
     * (difference being number of underscores)<br>
     * true - TABLE1__TABLE1COLUMN1__TABLE2__FK<br>
     * false - TABLE1__TABLE1COLUMN1_TABLE2_FK
     */
    @Parameter(property = "generate.isFSKeyFormat")
    private boolean isFSKeyFormat;
