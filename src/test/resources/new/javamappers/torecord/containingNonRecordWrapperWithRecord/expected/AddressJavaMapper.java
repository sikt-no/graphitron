        ...
        if (address != null) {
            for (var itAddress : address) {
                ...
                if (inner != null && arguments.contains(pathHere + "inner")) {
                    var cityJOOQ = inner.getCityJOOQ();
                    if (cityJOOQ != null && arguments.contains(pathHere + "inner/cityJOOQ")) {
                        mapperAddressJavaRecord.setCityJOOQ(transform.addressCityJOOQToJOOQRecord(cityJOOQ, pathHere + "inner/cityJOOQ"));
                    }

                    var cityJava = inner.getCityJava();
                    if (cityJava != null && arguments.contains(pathHere + "inner/cityJava")) {
                        mapperAddressJavaRecord.setCityJava(transform.addressCityJavaToJavaRecord(cityJava, pathHere + "inner/cityJava"));
                    }
