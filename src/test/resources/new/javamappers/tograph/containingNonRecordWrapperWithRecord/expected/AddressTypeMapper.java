        ...
        if (mapperAddressJavaRecord != null) {
            for (var itMapperAddressJavaRecord : mapperAddressJavaRecord) {
                ...
                if (select.contains(pathHere + "inner")) {
                    ...
                    if (select.contains(pathHere + "inner/cityJOOQ")) {
                        inner.setCityJOOQ(transform.addressCityJOOQRecordToGraphType(cityJOOQ, pathHere + "inner/cityJOOQ"));
                    }

                    if (select.contains(pathHere + "inner/cityJava")) {
                        inner.setCityJava(transform.addressCityJavaToGraphType(cityJava, pathHere + "inner/cityJava"));
                    }
