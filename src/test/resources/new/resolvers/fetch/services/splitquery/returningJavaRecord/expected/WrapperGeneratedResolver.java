...
public class WrapperGeneratedResolver implements WrapperResolver {
    ...
    @Override
    public CompletableFuture<DummyTypeRecord> query(Wrapper wrapper, DataFetchingEnvironment env)
            throws Exception {
        ...
        return new ServiceDataFetcher<>(transform).load(
                ...
                (ids) -> resolverFetchService.queryJavaRecord(ids),
                (transform, response) -> transform.dummyTypeRecordToGraphType(response, ""));
    }
}
