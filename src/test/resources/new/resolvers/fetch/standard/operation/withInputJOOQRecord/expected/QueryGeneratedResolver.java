...
public class QueryGeneratedResolver implements QueryResolver {
    ...
    @Override
    public CompletableFuture<DummyType> query(CustomerInputTable in, DataFetchingEnvironment env)
            throws Exception {
    ...
    @Override
    public CompletableFuture<List<DummyType>> queryListed(List<CustomerInputTable> in,
                                                          DataFetchingEnvironment env) throws Exception {
        var transform = new RecordTransformer(env, this.ctx);

        var inRecordList = transform.customerInputTableToJOOQRecord(in, "in");
