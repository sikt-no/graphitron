...
public class StoreDBQueries {
    public Map<String, City> cityOfMostValuableCustomerForStore(DSLContext ctx,
        ...
        var store_cityofmostvaluablecustomer = CUSTOMER.as("STORE_3239846765");
        var address_cityofmostvaluablecustomer = ADDRESS__ADDRESS_CITY_ID_FKEY.as("ADDRESS_3639882127");
        var store_cityofmostvaluablecustomer_address = store_cityofmostvaluablecustomer.address().as("CUSTOMER_839618971");
        return ctx
                .select(
                        STORE.getId(),
                        DSL.row(
