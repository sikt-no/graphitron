...
public class RecordTransformer extends AbstractTransformer {
    ...
    public OuterWrapper outerWrapperRecordToGraphType(List<CustomerRecord> input, String path) {
        return OuterWrapperTypeMapper.recordToGraphType(input, path, this);
    }
