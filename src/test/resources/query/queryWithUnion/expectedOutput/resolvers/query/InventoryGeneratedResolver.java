...
public class InventoryGeneratedResolver implements InventoryResolver {
    ...
    public CompletableFuture<List<Film2>> films(Inventory inventory, DataFetchingEnvironment env)
        ...
        DataLoader<String, List<Film2>> loader = DataLoaders.getDataLoader(env, "filmsForInventory", (ids, selectionSet) -> inventoryDBQueries.filmsForInventory(ctx, ids, selectionSet));
