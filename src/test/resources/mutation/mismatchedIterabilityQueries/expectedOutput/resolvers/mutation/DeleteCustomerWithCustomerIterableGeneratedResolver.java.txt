...
import fake.graphql.example.package.api.DeleteCustomerWithCustomerIterableMutationResolver;
...
public class DeleteCustomerWithCustomerIterableGeneratedResolver implements DeleteCustomerWithCustomerIterableMutationResolver {
    @Inject
    DSLContext ctx;
    ...
    private Map<String, Customer> getResultCustomer(DSLContext ctx,
        ...
        return customerDBQueries.loadCustomerByIdsAsNode(ctx, ids, select.withPrefix("result/customer"));
    }
}
