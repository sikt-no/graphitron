...
public class EditCustomerWithCustomerResponseGeneratedResolver implements EditCustomerWithCustomerResponseMutationResolver {
    ...
    public CompletableFuture<EditResponseWithCustomer> editCustomerWithCustomerResponse(
        ...
        var inputRecordCustomer = getEditResponseWithCustomerCustomer(transform, inputRecord, transform.getSelect());
    ...
    private Customer getEditResponseWithCustomerCustomer(RecordTransformer transform, CustomerRecord idContainer,
            SelectionSet select) {
