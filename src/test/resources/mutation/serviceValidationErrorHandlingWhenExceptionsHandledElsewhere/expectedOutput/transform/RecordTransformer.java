...
public class RecordTransformer extends AbstractTransformer {
    ...
    public EditCustomerResponse2 editCustomerResponse2RecordToGraphType(EditCustomerResponse1 input,
                                                                        String path) {
        return EditCustomerResponse2TypeMapper.recordToGraphType(input, path, this);
    }
