    ...
    public static List<EditResponseLevel1> toGraphType(List<TestCustomerRecord> testCustomerRecord,
        ...
        if (testCustomerRecord != null) {
            for (var itTestCustomerRecord : testCustomerRecord) {
                ...
                if (recordList != null && select.contains(pathHere + "customerList")) {
                ...
                if (edit2A != null && select.contains(pathHere + "edit2A")) {
                ...
                if (testCustomerInnerRecord != null && select.contains(pathHere + "edit2ADouble")) {
                ...
                if (testCustomerInnerRecordList != null && select.contains(pathHere + "edit2AList")) {
                ...
                var recordList = itTestCustomerRecord.getRecordList();
                if (recordList != null && select.contains(pathHere + "edit2B")) {
                    var edit2B = new EditResponseLevel2B();
                    if (select.contains(pathHere + "edit2B/edit3")) {
                ...
                var recordList = itTestCustomerRecord.getRecordList();
                if (recordList != null && select.contains(pathHere + "edit2CList")) {
