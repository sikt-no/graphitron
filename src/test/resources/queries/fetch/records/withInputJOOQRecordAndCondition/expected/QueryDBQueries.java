...
public class QueryDBQueries {
    public static CustomerTable customerForQuery(DSLContext ctx, CustomerRecord inRecord,
        ...
        return ctx
                ...
                .and(no.fellesstudentsystem.graphitron.codereferences.conditions.RecordCustomerCondition.customerString(CUSTOMER, inRecord != null ? inRecord.getFirstName() : null))
                .and(no.fellesstudentsystem.graphitron.codereferences.conditions.RecordCustomerCondition.customerJOOQRecord(CUSTOMER, inRecord))
