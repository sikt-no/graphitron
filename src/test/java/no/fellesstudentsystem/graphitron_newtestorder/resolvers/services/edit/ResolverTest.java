package no.fellesstudentsystem.graphitron_newtestorder.resolvers.services.edit;
...
public class ResolverTest extends GeneratorTest {
    ...
    void undefinedServiceMethod() {
        assertThatThrownBy(() -> generateFiles("undefinedServiceMethod"))
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessageContaining("Service reference no.fellesstudentsystem.graphitron_newtestorder.codereferences.services.ResolverMutationService does not contain method named UNDEFINED");
    }
