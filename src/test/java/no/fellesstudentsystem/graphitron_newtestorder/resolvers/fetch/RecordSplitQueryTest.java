...
@DisplayName("Fetch resolvers - Non-root resolvers with input records")
public class RecordSplitQueryTest extends GeneratorTest {
    public static final String SRC_TEST_RESOURCES_PATH = "resolvers/standard/fetch/splitquery";

    public RecordSplitQueryTest() {
        super(SRC_TEST_RESOURCES_PATH, DUMMY_RECORD.get(), DUMMY_SERVICE.get());
    }
