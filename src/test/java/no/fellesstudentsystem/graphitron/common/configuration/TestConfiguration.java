...
public class TestConfiguration {
    ...
    public static void setProperties(List<ExternalReference> references, List<GlobalTransform> globalTransforms, List<Extension> extendedClasses) {
        GeneratorConfig.setProperties(
                ...
                references,
                Set.of(
                    "no.fellesstudentsystem.graphitron.codereferences.conditions",
                    "no.fellesstudentsystem.graphitron.codereferences.dummyreferences",
                    "no.fellesstudentsystem.graphitron.codereferences.records",
                    "no.fellesstudentsystem.graphitron.codereferences.services",
                    "no.fellesstudentsystem.graphitron.codereferences.transforms"
                ),
                globalTransforms,
                extendedClasses
        );
