 ...
 * {@link no.sikt.graphitron.rewrite.schema.input.SchemaRecipe}, and
 * {@link AbstractRewriteMojo#expandRecipe} expands that recipe into
 * {@link no.sikt.graphitron.rewrite.schema.input.SchemaInput} records. One seam rather than two:
