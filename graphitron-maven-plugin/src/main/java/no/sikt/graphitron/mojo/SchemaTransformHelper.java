...
public class SchemaTransformHelper {
     ...
     * @param descriptionSuffixFilename the filename to look for, or null to return an empty map
     * @return a map of feature names to their description suffixes, or empty map if filename is null
     */
