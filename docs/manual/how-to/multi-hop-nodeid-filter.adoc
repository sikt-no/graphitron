...
When the lift fails at some step, the schema is asking the runtime to walk a JOIN with translation. That shape is real but is not what R114 ships; the diagnostic names the failing step and points back to this article.
