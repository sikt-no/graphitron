...
* xref:federation-keys.adoc[How-to: Federation key fields] is the entity-side companion; it covers `@key`, multi-alternative dispatch, compound keys, and the `resolvable: false` flag for entities owned by another subgraph.
