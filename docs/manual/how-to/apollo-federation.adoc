...
* xref:../../architecture/getting-started.adoc#federation[Getting started: Federation] covers the runtime framing this recipe is the operational extract of; it includes the broader architectural context for the dispatcher.
