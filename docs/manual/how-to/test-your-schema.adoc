...
For the rewrite-internal tier model (unit/pipeline/compilation/execution), see xref:../../../architecture/testing.adoc[the test-tier guide]. This recipe is about the consumer's execution-tier setup, not the rewrite's tier choices.
