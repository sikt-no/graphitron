...
* xref:../../architecture/getting-started.adoc[Architecture: Getting started] covers the contributor-facing pipeline detail (sealed hierarchies, variant taxonomy, generator dispatch).
