...
* *Input types* take their backing from the Java *parameter* type the input flows into (the xref:service.adoc[`@service`] / xref:condition.adoc[`@condition`] method parameter), or from xref:table.adoc[`@table`].
