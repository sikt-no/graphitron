...
the parameter receives it exactly as the spelled-out form does. Naming the column is then a matter of
saying out loud what the build would infer, which is worth doing where the reader benefits.
