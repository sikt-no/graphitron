...
* xref:../../how-to/error-channel.adoc[How-to: The errors channel] (Phase 3) covers union vs single-type carriers, `description:` vs exception message, and the `path:` slot's contents.
