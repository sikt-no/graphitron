...
* xref:../../how-to/external-code.adoc[How-to: Wiring external Java code] (Phase 3) covers the rewrite plugin's classpath setup, method-name conventions, and the lift-into-typed-record patterns.
