...
* xref:../../how-to/migrating-from-legacy.adoc[How-to: Migrating from the legacy generator] (Phase 3) covers the full directive-by-directive migration matrix, including the rejected-stub directives.
