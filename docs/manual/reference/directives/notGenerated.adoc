...
| `field: T @notGenerated` on a class-backed parent | A typed Java accessor | A class-backed parent (Java record / POJO) must expose the data through a typed Java-record accessor.
