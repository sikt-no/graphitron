...
* xref:../../architecture/getting-started.adoc[Getting started with the rewrite runtime] covers the dev loop's broader runtime framing (the LSP, the schema watcher, the classpath watcher) the `dev` goal is the operational extract of.
