...
[deferred] <message> [— see roadmap/<plan-slug>.md]
----
...
*Sample line.* `[deferred] split-batch emitter does not yet support @condition with a join step — see roadmap/condition-join-step.md`.
