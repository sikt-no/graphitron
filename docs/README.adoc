...
The rewrite-specific architecture docs live under `/graphitron-rewrite/docs/` and the roadmap under `/graphitron-rewrite/roadmap/`. Both render into this site, but their authoring conventions stay in their own folders.
