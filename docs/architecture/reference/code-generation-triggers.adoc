...
*See also:*
- xref:../explanation/rewrite-design-principles.adoc[Rewrite Design Principles] ; architectural and technical principles for the rewrite pipeline
