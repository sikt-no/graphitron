...
The design principles that govern classifier and emitter, the dispatch-axis model, the typed-rejection contract, and how the fact-oriented pipeline fits together end to end: capture into the fact store, the derived strata, planning into commands, and the render fold.
