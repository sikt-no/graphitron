...
The practical approach is PostgreSQL Row-Level Security with session variables set per request. See [Runtime Extension Points](RUNTIME-EXTENSION-POINTS.md) for how that wires together with `GraphitronContext`.
