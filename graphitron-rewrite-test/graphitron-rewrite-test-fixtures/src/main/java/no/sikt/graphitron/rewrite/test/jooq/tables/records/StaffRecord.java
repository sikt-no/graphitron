...
public class StaffRecord extends UpdatableRecordImpl<StaffRecord> {
     ...
     */
    public StaffRecord(Integer staffId, String firstName, String lastName, Integer addressId, String email, Integer storeId, Boolean active, String username, LocalDateTime lastUpdate) {
        super(Staff.STAFF);
