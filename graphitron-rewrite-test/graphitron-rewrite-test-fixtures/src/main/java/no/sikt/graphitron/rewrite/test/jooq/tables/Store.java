...
import no.sikt.graphitron.rewrite.test.jooq.tables.Address.AddressPath;
import no.sikt.graphitron.rewrite.test.jooq.tables.Customer.CustomerPath;
import no.sikt.graphitron.rewrite.test.jooq.tables.Inventory.InventoryPath;
import no.sikt.graphitron.rewrite.test.jooq.tables.Staff.StaffPath;
...
public class Store extends TableImpl<StoreRecord> {
     ...
     */
    public final TableField<StoreRecord, Integer> MANAGER_STAFF_ID = createField(DSL.name("manager_staff_id"), SQLDataType.INTEGER, this, "");
