...
import no.sikt.graphitron.rewrite.test.jooq.tables.Payment.PaymentPath;
import no.sikt.graphitron.rewrite.test.jooq.tables.Rental.RentalPath;
import no.sikt.graphitron.rewrite.test.jooq.tables.Store.StorePath;
...
public class Customer extends TableImpl<CustomerRecord> {
     ...
     */
    public final TableField<CustomerRecord, LocalDate> CREATE_DATE = createField(DSL.name("create_date"), SQLDataType.LOCALDATE.nullable(false).defaultValue(DSL.field(DSL.raw("CURRENT_DATE"), SQLDataType.LOCALDATE)), this, "");
