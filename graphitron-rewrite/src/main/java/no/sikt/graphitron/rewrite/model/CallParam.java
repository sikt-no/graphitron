 ...
 * extract the value from the GraphQL execution context, and whether the argument is a list.
 * No column or type information is included beyond what is embedded in the
