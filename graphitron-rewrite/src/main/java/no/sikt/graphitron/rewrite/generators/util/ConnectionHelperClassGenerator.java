...
public class ConnectionHelperClassGenerator {
    ...
    public static List<TypeSpec> generate() {
        ...
        var decodeCursor = MethodSpec.methodBuilder("decodeCursor")
            ...
            .addStatement("String[] parts = json.split(\",\")")
            .addStatement("Object[] values = new Object[parts.length]")
            .addCode("for (int i = 0; i < parts.length; i++) {\n")
            .addCode("    String part = parts[i].strip();\n")
