...
-- ===========================
-- platformidfixture schema
-- ===========================
--
-- Synthetic fixture tables used exclusively by PlatformIdPipelineTest and the JooqCatalog
...
CREATE SCHEMA platformidfixture;
...
CREATE TABLE platformidfixture.baz (
    id   varchar(50) PRIMARY KEY
);

CREATE TABLE platformidfixture.bar (
    id_1 varchar(50) NOT NULL REFERENCES platformidfixture.baz(id),
...
CREATE TABLE platformidfixture.qux (
