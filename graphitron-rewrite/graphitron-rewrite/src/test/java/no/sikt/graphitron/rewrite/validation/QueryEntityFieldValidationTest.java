...
import no.sikt.graphitron.rewrite.model.QueryField.QueryEntityField;
...
class QueryEntityFieldValidationTest {
    ...
    enum Case implements ValidatorCase {
        ...
        STUBBED("entity query field — not yet implemented, produces stubbed-variant error",
            new QueryEntityField("Query", "_entities", null, new ReturnTypeRef.PolymorphicReturnType("Film", new FieldWrapper.Single(true))),
            List.of(stubbedError("Query._entities", QueryEntityField.class)));
