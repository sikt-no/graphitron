 ...
 * the accessor-coverage check resolves against on the handler's source class (R244).
 *
 ...
 * the in-scope flip (slice-1 commit 3), and walker unit tests supply their own. Mirrors R238's
 * choice to keep the walker a thin layer over an explicit substrate rather than over
 * {@code BuildContext}.
 */
@FunctionalInterface
