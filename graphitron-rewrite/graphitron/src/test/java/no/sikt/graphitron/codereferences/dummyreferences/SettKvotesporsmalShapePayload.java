...
/**
 * R178 step 3 SettKvotesporsmal-shape regression fixture: a top-level {@code @record} payload
 ...
 * routing the with-{@code @field} form through the standard {@code @record}-parent path
