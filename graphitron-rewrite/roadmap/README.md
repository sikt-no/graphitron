...
| ID | Item | Status | Plan |
|---|---|---|---|
| `R60` | Auto-derive BatchKey from typed TableRecord accessor on @record parents | Spec | [plan](auto-derive-batchkey-from-typed-record-accessor.md) |
...
- `R60` [**Auto-derive BatchKey from typed TableRecord accessor on @record parents**](auto-derive-batchkey-from-typed-record-accessor.md) — Spec
