...
- [**`FkJoin` model cleanup**](fkjoin-model-cleanup.md): Three small follow-ups on `JoinStep.FkJoin` that share files and reviewer context. Do as one sweep.
...
- [**`FkJoin` model cleanup**](fkjoin-model-cleanup.md) — Backlog, cleanup
