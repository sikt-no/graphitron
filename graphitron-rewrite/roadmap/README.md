...
- `R79` [**Generated QueryConditions composite-key call-site emits Row instead of RowN**](query-conditions-composite-key-rown-call-site.md) — Backlog, architecture
