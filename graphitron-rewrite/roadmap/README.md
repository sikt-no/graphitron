...
- `R58` [**Make the typed `Rejection` hierarchy load-bearing across producers**](lift-unclassified-field-onto-sealed-result.md) — In Review, architecture
