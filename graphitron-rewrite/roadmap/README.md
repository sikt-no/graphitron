...
- `R60` [**Auto-derive BatchKey from typed TableRecord accessor on @record parents**](auto-derive-batchkey-from-typed-record-accessor.md) — Backlog, architecture
