...
| `R93` | LSP quick-fix: ExternalCodeReference name → className migration | Ready | [plan](lsp-externalcodereference-name-migration.md) |
...
- `R93` [**LSP quick-fix: ExternalCodeReference name → className migration**](lsp-externalcodereference-name-migration.md) — Ready, Backlog
