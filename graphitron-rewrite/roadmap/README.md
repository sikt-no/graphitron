...
- `R41` [**@field(name:) on @service method args**](service-arg-java-name-override.md): Tombstone. Superseded by R53 ([`external-code-reference-arg-mapping.md`](external-code-reference-arg-mapping.md)) before R41's user-facing surface ever shipped. The R41 file deletes when R53 reaches Done; until then it serves as a redirect. _(blocked by [external-code-reference-arg-mapping](external-code-reference-arg-mapping.md))_
...
- `R41` [**@field(name:) on @service method args**](service-arg-java-name-override.md) — Backlog, architecture, blocked by [external-code-reference-arg-mapping](external-code-reference-arg-mapping.md)
