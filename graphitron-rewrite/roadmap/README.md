...
| `R49` | Stub: scalar/`@record`-returning `@service` child field (`ServiceRecordField`) | In Progress | [plan](service-record-field.md) |
...
- `R49` [**Stub: scalar/`@record`-returning `@service` child field (`ServiceRecordField`)**](service-record-field.md) — In Progress, stubs
