...
| `R49` | Stub: scalar/`@record`-returning `@service` child field (`ServiceRecordField`) | Ready | [plan](service-record-field.md) |
...
- `R49` [**Stub: scalar/`@record`-returning `@service` child field (`ServiceRecordField`)**](service-record-field.md) — Ready, stubs
