...
| `R67` | Promote graphitron-test to graphitron-sakila-example (rename, Quarkus runtime, consumer test pattern) | Ready | [plan](rewrite-example-quarkus-jaxrs.md) |
...
- `R67` [**Promote graphitron-test to graphitron-sakila-example (rename, Quarkus runtime, consumer test pattern)**](rewrite-example-quarkus-jaxrs.md) — Ready, architecture
