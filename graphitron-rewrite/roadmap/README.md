...
| ID | Item | Status | Plan |
|---|---|---|---|
| `R60` | Auto-derive BatchKey from typed TableRecord accessor on @record parents | Ready | [plan](auto-derive-batchkey-from-typed-record-accessor.md) |
...
- `R60` [**Auto-derive BatchKey from typed TableRecord accessor on @record parents**](auto-derive-batchkey-from-typed-record-accessor.md) — Ready
...
- `R58` [**Make the typed `Rejection` hierarchy load-bearing across producers**](lift-unclassified-field-onto-sealed-result.md) — Spec, architecture
