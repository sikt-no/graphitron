...
_Generated by `graphitron-rewrite-roadmap-tool`. Regenerate with `mvn -pl :graphitron-rewrite-roadmap-tool exec:java` (or `mise r roadmap`). Edit per-item `*.md` files in this directory; never edit this file by hand._
