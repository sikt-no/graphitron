...
- `R78` [**Typed jOOQ class references for multi-schema correctness (TableRef, TableRecordRef, KeyRef)**](jooq-multi-schema-typed-references.md) — Backlog, architecture
