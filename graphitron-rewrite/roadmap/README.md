...
| `R68` | Diataxis user manual: absorb legacy README into the docs site | In Progress | [plan](diataxis-user-manual.md) |
...
- `R68` [**Diataxis user manual: absorb legacy README into the docs site**](diataxis-user-manual.md) — In Progress, architecture
