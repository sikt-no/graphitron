...
`graphitron-rewrite/` is a nested monorepo with its own parent pom (`graphitron-rewrite-parent`, `10-SNAPSHOT`). Ten modules cover the generator, its inputs, its consumers, and the tooling that wraps both ends:
