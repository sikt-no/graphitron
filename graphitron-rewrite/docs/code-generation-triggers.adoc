...
| DataLoader keys | `BatchKey.java` | `RowKeyed` / `RecordKeyed` / `MappedRowKeyed` / `MappedRecordKeyed` / `LifterRowKeyed` |
...
- *Directive reference with examples*: link:https://github.com/sikt-no/graphitron/tree/claude/graphitron-rewrite/graphitron-codegen-parent/graphitron-java-codegen/README.md[graphitron-java-codegen README]
