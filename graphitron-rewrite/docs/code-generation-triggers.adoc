...
- *Directive reference with examples*: link:https://github.com/sikt-no/graphitron/tree/main/graphitron-codegen-parent/graphitron-java-codegen/README.md[graphitron-java-codegen README]
