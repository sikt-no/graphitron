...
public final class LspClassificationLabels {
    ...
    public static String projectionLabel(FieldClassification c) {
        return switch (c) {
            ...
            case FieldClassification.Constructor x -> FieldClassification.Constructor.class.getSimpleName();
            ...
            case FieldClassification.SingleRecordTableFromReturning x -> FieldClassification.SingleRecordTableFromReturning.class.getSimpleName();
    ...
    public static String projectionTypeLabel(TypeClassification c) {
        return switch (c) {
            ...
            case TypeClassification.UnbackedPojoResult x -> TypeClassification.UnbackedPojoResult.class.getSimpleName();
