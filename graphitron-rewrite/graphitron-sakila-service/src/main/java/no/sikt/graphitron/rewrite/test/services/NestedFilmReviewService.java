...
/**
 * R370 compilation-tier fixture: the nested-payload counterpart of {@link FilmReviewService#submit}.
 ...
 * single fixture reaches both remaining in-hand {@code bestGuess} sites this R370 pass fixes:
 ...
 *
 * <p>Reuses R12's {@link FilmReviewBadRatingException} / {@link FilmReviewMissingFilmException} so
 ...
 * the two swaps protect. See R370.
 */
public final class NestedFilmReviewService {
     ...
     * {@code new NestedFilmReviewPayloadHolder.Payload(errors)} via the R370-fixed
