...
public final class AnnotationSpecTest {
    ...
    public void defaultAnnotation() {
        ...
        assertThat(toString(taco)).isEqualTo(""
                ...
                + "import no.sikt.graphitron.javapoet.AnnotationSpecTest;\n"
                + "\n"
    ...
    public void defaultAnnotationWithImport() {
        ...
        JavaFile file = JavaFile.builder("no.sikt.graphitron.javapoet", typeBuilder.build()).build();
    ...
    public void emptyArray() {
        ...
        assertThat(builder.build().toString()).isEqualTo(
                "@no.sikt.graphitron.javapoet.AnnotationSpecTest.HasDefaultsAnnotation(" + "n = {}" + ")");
        builder.addMember("m", "$L", "{}");
        assertThat(builder.build().toString())
                .isEqualTo(
                        "@no.sikt.graphitron.javapoet.AnnotationSpecTest.HasDefaultsAnnotation("
                                + "n = {}, m = {}"
                                + ")");
    }
    ...
    public void dynamicArrayOfEnumConstants() {
        ...
        assertThat(builder.build().toString()).isEqualTo(
                "@no.sikt.graphitron.javapoet.AnnotationSpecTest.HasDefaultsAnnotation("
                        + "n = no.sikt.graphitron.javapoet.AnnotationSpecTest.Breakfast.PANCAKES"
                        + ")");
        ...
        assertThat(builder.build().toString()).isEqualTo(
                "@no.sikt.graphitron.javapoet.AnnotationSpecTest.HasDefaultsAnnotation("
                        + "n = {"
                        + "no.sikt.graphitron.javapoet.AnnotationSpecTest.Breakfast.PANCAKES"
                        + ", no.sikt.graphitron.javapoet.AnnotationSpecTest.Breakfast.WAFFLES"
                        + ", no.sikt.graphitron.javapoet.AnnotationSpecTest.Breakfast.PANCAKES"
                        + "})");
    ...
    public void defaultAnnotationToBuilder() {
        ...
        assertThat(builder.build().toString()).isEqualTo(
                "@no.sikt.graphitron.javapoet.AnnotationSpecTest.HasDefaultsAnnotation("
                        + "o = no.sikt.graphitron.javapoet.AnnotationSpecTest.Breakfast.PANCAKES"
                        + ", p = 1701"
                        + ", f = 11.1"
                        + ", m = {9, 8, 1, 123}"
                        + ", l = java.lang.Override.class"
                        + ", j = @no.sikt.graphitron.javapoet.AnnotationSpecTest.AnnotationA"
                        + ", q = @no.sikt.graphitron.javapoet.AnnotationSpecTest.AnnotationC(\"bar\")"
