...
/**
 * The warmed docs-retrieval handle: the in-memory {@link EmbeddingStore} rebuilt from the
 ...
 * KNN width error. The {@link EmbeddingStore} seam intentionally does not expose its width, so the bundled value
